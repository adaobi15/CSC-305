...
fn my_entry_point(boot_info: &'static mut bootloader_api::BootInfo) -> ! {
    ...
    let mut frame_buffer_writer = 
        ...
        frame_buffer_writer.set_pos(10, 100);
        macro_rules! print{
            ($($arg:tt)*) => ({
                use core::fmt::Write;
    ...
    frame_buffer_writer.set_x_pos(30);
    
    //writeln!(frame_buffer_writer, "Testing testing {} and {}", 1, 4.0/2.0).unwrap();
   // frame_buffer_writer.change_cursor_position(10000,870);
    print!( "Testing testing {} and {} \n", 90, 40.0/20.0);
    frame_buffer_writer.set_x_pos(1000);
